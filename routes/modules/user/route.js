...
module.exports = function (express) {
  ...
  route.put("/address/:id", validateData.address, addressController.update);
  ...
  route.put("/message/:id", validateData.message, messageController.update);
  ...
  route.put("/role/:id", validateData.role, roleController.update);
  ...
  route.put("/photo/:id", validateData.photo, photoController.update);
  ...
  route.put("/plan/:id", validateData.plan, planController.update);
  route.delete("/plan/:id", planController.delete);
  //user
  route.post("/user", validateData.user, userController.save);
  route.get("/user/:id", userController.get);
  route.get("/user", userController.getAll);
  route.put("/user/:id", validateData.user, userController.update);
