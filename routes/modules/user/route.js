...
module.exports = function (express) {
  ...
  route.delete("/message/:id", messageController.delete);
   //notification
   route.post("/notification", validateData.notification, notificationController.save);
   route.get("/notification/:id", notificationController.get);
   route.get("/notification", notificationController.getAll);
   route.update("/notification/:id",validateData.notification, notificationController.update);
  ...
  route.update("/permission/:id",validateData.permission, permissionController.update);
  route.delete("/permission/:id", permissionController.delete);
   //role permission
   route.post("/role-permission", validateData.rolepermission, rolePermissionController.save);
   route.get("/role-permission/:id", rolePermissionController.get);
   route.get("/role-permission", rolePermissionController.getAll);
   route.update("/role-permission/:id",validateData.rolepermission, rolePermissionController.update);
